          ...
          <tbody>
            ...
            <tr>
              <td colSpan={5}>
                ...
                <br />
                County: <input type="text" className="underline-input long" />
                Occupation:
                <input type="text" className="underline-input long" />
                <br />
                Social Security #:
                ...
                <input type="text" className="underline-input long" /> Was
                Lifting a Factor?
                <input
                  type="radio"
                  name="liftingFector"
            ...
            <tr>
              <td colSpan={5}>
                ...
                No
                <br />
                By Whom: <input type="text" className="underline-input long" />
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                />
                <br />
                What should be done to prevent the accident from happening
                again?
                <br />
                <input
                  type="text"
